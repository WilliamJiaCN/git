...
@Data
@ToString
public class AlterationDeliveryChangeReqDTO implements Serializable{
	...
	@Mapping @Required
	private @ApiModelProperty(value="创建人Id",hidden=true,required=true) Integer createUser;
	@Mapping @Required
	private @ApiModelProperty(value="创建人姓名",hidden=true,required=true) String createUserName;
	@Mapping @Required
	private @ApiModelProperty(value="创建时间",hidden=true,required=true) Long createTime;
	@Mapping @Required
