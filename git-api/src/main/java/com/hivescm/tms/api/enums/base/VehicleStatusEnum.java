...
public enum VehicleStatusEnum {	
	...
	VehicleStatusEnum(int type, String name) {
		this.type = type;
		this.name = name;
	}
	...
	public static String getName(int type) {
		for (VehicleStatusEnum ele : VehicleStatusEnum.values()) {
			if (ele.getType() == type)
				return ele.getName();
		}
		return null;
...
/*	public static int getType(int type) {
	...
	public static VehicleStatusEnum getEnum(int type) {
		for (VehicleStatusEnum ele : VehicleStatusEnum.values()) {
			if (ele.getType() == type)
				return ele;
		}
		return VehicleStatusEnum.CHECK;
	}
