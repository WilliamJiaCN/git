 ...
 * @Description:
 * @Author: MaGuoDong
 * @Date: Created in 2018/5/25 15:46
 * @company 蜂网供应链管理（上海）有限公司
 */
@Data
@ToString
public class PickHandlingOrderDetailEsDTO implements Serializable {

    private static final long serialVersionUID = 5371348670195055341L;
